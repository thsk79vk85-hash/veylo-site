...
- `[free][qa]` Smoke-test the refreshed showcase in physical iPhone Safari and Android Chrome, including keyboard navigation/screen reader, reduced motion, all four demo panels and signup states. Browser viewport checks have passed; this is not a native-device result.
